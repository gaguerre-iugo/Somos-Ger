...
- Los recursos se versionaron finalmente como `project-adaptations.js?v=somos-ger-54` y `project-interface.css?v=somos-ger-24` para invalidar cachés previas.
