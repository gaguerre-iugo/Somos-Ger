...
- `pg026027_sec001.html` dejó de comprimir una lámina vertical de 595 × 1191 px en la altura disponible. Se recompuso horizontalmente en tres zonas —Derechos, figura y Deberes— conservando los veinte enunciados y las dos partes de la ilustración. El texto pasó de unos 6 px efectivos a 17 px en la prueba local de 1280 × 720, sin desbordamientos. También se corrigieron el título visual y su versión de voz; `bundleVersion: somos-ger-5` invalida las traducciones anteriores almacenadas en caché.
