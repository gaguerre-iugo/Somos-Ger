...
- Los recursos se versionaron finalmente como `project-adaptations.js?v=somos-ger-56` y `project-interface.css?v=somos-ger-24` para invalidar cachés previas. El runtime estable de 8,75 MB usa `base.bundle.local.js?v=somos-ger-runtime-1`, lo que permite reutilizarlo entre páginas en lugar de volver a transferirlo.
